...
LEPERS STANDARD — CANONICAL PRODUCTION PACKAGE CONTRACT
...
Then add: Epizodes caurviju motīvs; Raksturu funkcijas montāžā.
...
# 5. Teaseri, štorkas un promo āķi
Include: Atklāšanas štorka — ieteicamā secība, as a table with # / Avots / Kadrs vai sinhrons / Funkcija; 30 sekunžu promo VO; 15 sekunžu promo VO; Sociālo tīklu āķi.
...
QUALITY BAR
The result must read like a senior executive producer + story editor + VO writer has prepared an editor-ready document, not like an AI summary. Be specific, timecoded, decisive and useful in the edit suite.
`.trim();
